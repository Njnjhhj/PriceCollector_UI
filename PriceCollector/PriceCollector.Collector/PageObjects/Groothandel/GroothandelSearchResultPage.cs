...
namespace PriceCollector.Collector.PageObjects.Groothandel
{
    public class GroothandelSearchResultPage : PageObjectBase
    {
        ...
        public IWebElement PriceValueElement(string itemId) => driver.UsingDriverImplicitTimeout(() => ProductItemBlock(itemId).FindElement(By.CssSelector("ins span.woocommerce-Price-amount")), TimeSpan.FromMilliseconds(100));
